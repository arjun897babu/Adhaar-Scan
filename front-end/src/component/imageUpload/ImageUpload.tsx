    ...
    <div className="max-w-sm bg-white rounded-lg shadow-md  ">
      <div className="px-4 py-6">
        <div
          ...
          className={`max-w-sm p-6 mb-4 bg-gray-100 border-dashed border-2 border-indigo-400 rounded-lg items-center mx-auto text-center cursor-pointer ${imageSrc ? "" : "flex items-center justify-center"
            }`}
        >
          <input
            id="uploadInput"
